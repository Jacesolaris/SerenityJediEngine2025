...
// at this point the filename should have had the "scriptsmp" (Q3_SCRIPT_DIR) added to it (but not the IBI extension)
//
void ICARUS_InterrogateScript(const char* filename)
{
	...
	//////////////////////////////////
	//
	// ensure "scriptsmp" (Q3_SCRIPT_DIR), which will be missing if this was called recursively...
	//
...
{
	const sharedEntity_t* ent = SV_Gentity_num(entID);
