...
// Changes Globals:		-
//===========================================================================
static void AAS_ShowPolygon(const int color, const int numpoints, vec3_t* points)
{
	for (int i = 0; i < MAX_DEBUGPOLYGONS; i++)
	{
		if (!debugpolygons[i])
...
// Changes Globals:		-
//===========================================================================
static void AAS_ShowFacePolygon(const int facenum, const int color, const int flip)
{
	int i, edgenum;
	vec3_t points[128];
	aas_edge_t* edge;
