...
static void RT_RunStormtrooperAI(void)
{
	int b_state;
	//Execute our b_state
...
static void RT_Flying_MaintainHeight(void)
{
	float dif = 0;
...
static void RT_Flying_Strafe(void)
{
	int side;
	vec3_t end, right;
	trace_t tr;
...
static void RT_Flying_Attack(void)
{
...
static void RT_Flying_Think(void)
{
	if (UpdateGoal())
	{
