...
-------------------------
*/
static void Remote_MaintainHeight(void)
{
	float dif;
...
static void Remote_Fire(void)
{
	...
	gentity_t* missile = CreateMissile(NPCS.NPC->r.currentOrigin, forward, 1000, 10000, NPCS.NPC, qfalse);
...
-------------------------
*/
static void Remote_Attack(void)
{
...
-------------------------
*/
static void Remote_Patrol(void)
{
	Remote_MaintainHeight();
