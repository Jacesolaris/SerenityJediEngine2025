...
*/
static void Use_target_remove_powerups(gentity_t* ent, gentity_t* other, const gentity_t* activator)
{
	if (!activator->client)
	{
		return;
...
static void Use_Secret(gentity_t* ent, gentity_t* other, gentity_t* activator)
{
	if (!activator || !activator->client)
	{
