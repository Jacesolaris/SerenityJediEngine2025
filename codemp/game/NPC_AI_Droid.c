...
-------------------------
*/
static void R2D2_PartsMove(void)
{
	// Front 'eye' lense
...
-------------------------
*/
static void R2D2_TurnAnims(void)
{
