...
// NOTENOTE: If you change the output name of SerenityJediEngine2025-rdsp, change this define too!

#define DEFAULT_RENDER_LIBRARY	"SerenityJediEngine2025-rdsp"
...
void CL_Init()
{
	...
	Com_Printf("---------------------Build date 11/043/2024-----------------------\n");
	Com_Printf("-----------------------------------------------------------------\n");
