...
-------------------------
*/
static void g_droideka_check_pain(const gentity_t* self, gentity_t* other, const vec3_t point, int damage, int mod, int hit_loc)
{
	if (rand() & 1)
	{
...
-------------------------
*/
static void droideka_ranged(const qboolean visible)
{
