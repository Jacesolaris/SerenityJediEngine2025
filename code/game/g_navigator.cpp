...
////////////////////////////////////////////////////////////////////////////////////////
static bool ViewTrace(const CVec3& a, const CVec3& b)
{
...
// Helper Function : View Trace
////////////////////////////////////////////////////////////////////////////////////////
static bool ViewNavTrace(const CVec3& a, const CVec3& b)
{
...
////////////////////////////////////////////////////////////////////////////////////////
static bool MoveTrace(const CVec3& Start, const CVec3& Stop, const CVec3& Mins, const CVec3& Maxs,
...
////////////////////////////////////////////////////////////////////////////////////////
static bool MoveTrace(gentity_t* actor, const CVec3& goalPosition, const bool IgnoreAllEnts = false)
{
...
////////////////////////////////////////////////////////////////////////////////////////
static void stupid_print(const char* data)
{
	gi.Printf(data);
}
...
void NAV::ShowStats()
{
	...
	mGraph.ProfilePrint("");
	mGraph.ProfilePrint("--------------------------------------------------------");
	mGraph.ProfilePrint("              Star Wars - SerenityJediEngine2025        ");
...
//
//////////////////////////////////////////////////////////////////////
static bool TestCollision(gentity_t* actor, SSteerUser& suser, const CVec3& ProjectVelocity, const float ProjectSpeed,
	const ESide Side,
...
static void ClearAllNavStructures()
{
