...
-------------------------`
*/
static void ATST_Hunt(qboolean visible, qboolean advance)
{
...
-------------------------
*/
static void ATST_Ranged(const qboolean visible, const qboolean advance, const qboolean altAttack)
{
