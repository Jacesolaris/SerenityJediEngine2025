...
//------------------------------------------
static void fx_target_beam_set_debounce(gentity_t* self)
{
...
//------------------------------------------
static void fx_target_beam_fire(gentity_t* ent)
{
	trace_t trace;
	vec3_t dir, org, end;
	qboolean open;
...
//------------------------------------------
static void fx_target_beam_fire_start(gentity_t* self)
{
