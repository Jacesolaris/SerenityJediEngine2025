...
static void TurboLaser_SetBoneAnim(gentity_t* eweb, const int startFrame, const int endFrame)
{
...
static void turret_set_models(gentity_t* self, const qboolean dying)
{
	if (dying)
	{
		if (!(self->spawnflags & SPF_TURRETG2_TURBO))
