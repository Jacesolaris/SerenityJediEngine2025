...
static void G_SpawnSubBSPGEntityFromSpawnVars(vec3_t posOffset, vec3_t angOffset)
{
	int i;
...
static qboolean SP_bsp_worldspawn()
{
	return qtrue;
}
...
static void G_SpawnExtraEntitiesFromString(const char* entityString)
{
	const char* entities;
